...
declare module "Drawing/Sprite" {
  ...
  export class SpriteImpl implements IDrawable {
     ...
     */
    constructor(
      imageOrConfig: Texture | ISpriteArgs,
      x: number,
      y: number,
      width: number,
      height: number
...
declare module "Drawing/Animation" {
  ...
  export class AnimationImpl implements IDrawable {
     ...
     */
    constructor(
      engineOrConfig: Engine | IAnimationArgs,
      sprites: Sprite[],
      speed: number,
      loop?: boolean
    );
...
declare module "TileMap" {
  ...
  export class TileMapImpl extends Class {
    ...
    on(
      ...
      handler: (event?: Events.PreUpdateEvent) => void
    ): void;
    on(
      eventName: Events.postupdate,
      handler: (event?: Events.PostUpdateEvent) => void
    ): void;
    on(
...
declare module "Events" {
  ...
  export class PreUpdateEvent extends GameEvent<
    Actor | Scene | Engine | TileMap | BaseCamera
  > {
    engine: Engine;
    delta: number;
...
declare module "Interfaces/LifecycleEvents" {
  ...
  export interface ICanInitialize {
    ...
    on(
      eventName: Events.initialize,
      handler: (event?: Events.InitializeEvent) => void
    ): void;
    once(
      eventName: Events.initialize,
      handler: (event?: Events.InitializeEvent) => void
...
declare module "Resources/Sound" {
  ...
  import {
    ...
    ExResponseType
  } from "Interfaces/IAudioImplementation";
  import { IAudio } from "Interfaces/IAudio";
  import { Engine } from "Engine";
  import { Promise } from "Promises";
  /**
...
declare module "Particles" {
  ...
  export class ParticleEmitterImpl extends Actor {
     ...
     */
    constructor(
      xOrConfig?: number | IParticleEmitterArgs,
      y?: number,
      width?: number,
      height?: number
    );
...
declare module "Engine" {
  ...
  export class Engine extends Class
    implements ICanInitialize, ICanUpdate, ICanDraw {
    /**
...
declare module "Actor" {
   ...
   * @hidden
   */
  export class ActorImpl extends Class
    implements
      IActionable,
      IEvented,
      IPointerEvents,
    ...
    on(
      ...
      handler: (evt: ExitTriggerEvent) => void
    ): void;
    on(
      eventName: Events.entertrigger,
      handler: (evt: EnterTriggerEvent) => void
    ): void;
    on(
